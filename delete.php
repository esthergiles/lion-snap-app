...
<div class="container-fluid px-1 py-5 mx-auto">
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            ...
            <p class="blue-text">You have requested to delete a reservation.</p>

                <h5 class="text-center mb-4">Are you sure?</h5>
                <div class="row justify-content-center">
                    <!-- TODO: update yes button to send to do_delete.php -->

                    <div class="form-group col-sm-6"><a href="do_delete.php?resid=<?php echo $resid;?>">  <button type="submit" class="btn-block btn-primary">Yes</button></a> </div>
                    <div class="form-group col-sm-6"><a href="manage.php"> <button type="submit" class="btn-block btn-primary">No</button></a> </div>
                </div>
            </div>
        </div>
    </div>
